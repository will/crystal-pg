...
private def ex(which)
  ...
  when "2566.1918905000002000" # issue #222
...
describe PG::Numeric do
  it "#to_f" do
    ...
    [
      ...
      {"2566.1918905000002000", 2566.1918905000002000_f64},
      {"-0.00009", -0.00009_f64},
  ...
  it "#to_big_r" do
    [
      ...
      {"2566.1918905000002000", br(12830959452500001, 5000000000000)},
      {"-0.00009", br(-9, 100000)},
  ...
  it "#to_s" do
    [
      ...
      {"2566.1918905000002000", "2566.1918905000002000"},
      {"800000", "800000"},
      {"0.3", "0.3"},
      {"0.03", "0.03"},
      {"0.003", "0.003"},
